    ...
    <main className="max-w-[1000px] mx-auto px-6 md:px-10 py-12 space-y-12 animate-in fade-in duration-500">
      ...
      <div className="space-y-12">
        ...
        <section className="space-y-4">
          <h3 className="text-xs font-black text-slate-500 uppercase tracking-[4px]">Executive Summary</h3>
          <div className="bg-[#21262d] rounded-[3rem] p-10 text-slate-300 leading-relaxed text-base border-2 border-blue-500/20 shadow-2xl">
            
            <div className="flex flex-col items-center mb-10 pb-10 border-b border-white/10 relative overflow-hidden">
               <div className="absolute top-0 right-0">
                  <div className={`text-[9px] font-black px-4 py-2 rounded-xl border-2 ${scoreBadge} tracking-[2px] uppercase shadow-lg`}>
                    {scoreText}
                  </div>
                </div>
                ...
                <div className="relative w-40 h-40 group transition-transform duration-1000">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center z-20">
                    <span className="text-6xl font-black tracking-tighter text-white leading-none drop-shadow-2xl">{displayScore}</span>
                    <span className="text-[8px] font-mono text-slate-500 mt-3 tracking-[3px] uppercase font-black">Score</span>
                  </div>
                </div>
            </div>

            <div className="prose prose-invert max-w-none">
              <p className="text-lg leading-relaxed text-slate-200 indent-0">
                {contract.summary}
              </p>
            </div>
          </div>
