      ...
      >
        ...
        <header style={{ backgroundColor: colors.primary, color: colors.white, padding: '24px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: `1px solid ${colors.slate200}` }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <h1 style={{ fontSize: '20px', fontWeight: 'bold', letterSpacing: '-0.025em', textTransform: 'uppercase', margin: 0 }}>BRAND DEAL SCANNER</h1>
          </div>
        </header>
        ...
        <footer style={{ marginTop: 'auto', backgroundColor: colors.primary, borderTop: `1px solid ${colors.slate200}`, padding: '40px 32px', textAlign: 'center', color: colors.white, breakInside: 'avoid' }}>
          <p style={{ fontSize: '10px', fontWeight: 'bold', color: colors.white, opacity: 0.6, textTransform: 'uppercase', marginBottom: '12px', letterSpacing: '0.1em' }}>Generated by Brand Deal Scanner</p>
          <p style={{ fontSize: '9px', color: colors.white, padding: '0 40px', lineHeight: 1.6, opacity: 0.5, margin: 0 }}>
            LEGAL DISCLAIMER: Brand Deal Scanner is an AI analysis tool and does not provide legal advice. This report is for informational purposes only. Consult a licensed attorney for official legal counsel.
          </p>
        </footer>
      </article>
    </div>
